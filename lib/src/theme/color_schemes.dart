...
/// Centralized icon/accent colors for grid items, stat cards, and event cards.
/// Use these instead of hardcoding `Color(0xFF...)` in widgets.
///
/// Usage: `GridIconColors.profile` or `GridIconColors.attendance`
class GridIconColors {
  GridIconColors._();

  static const Color profile = Color(0xFF5C6BC0);
  static const Color attendance = Color(0xFF26A69A);
  static const Color exams = Color(0xFFFF9800);
  static const Color timetable = Color(0xFF42A5F5);
  static const Color fees = Color(0xFFEF5350);
  static const Color results = Color(0xFF4CAF50);
  static const Color subjects = Color(0xFF7E57C2);
  static const Color activities = Color(0xFFFFA726);
  static const Color notices = Color(0xFF29B6F6);
  static const Color tasks = Color(0xFFFF7043);
}
