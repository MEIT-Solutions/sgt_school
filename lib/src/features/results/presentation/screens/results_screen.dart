      ...
      body: provider.isLoading
          ...
          : provider.error != null
              ...
              : provider.results.isEmpty
                  ? Center(child: AppEmptyState(icon: Icons.bar_chart, title: 'results.no_results'.tr()))
                  : Column(
                  children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.analytics_outlined, color: cs.onSecondary, size: 20),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: cs.onSecondary.withValues(alpha: 0.15),
                          ...
                          ClipRRect(
                            ...
                            child: LinearProgressIndicator(
                              ...
                              valueColor: AlwaysStoppedAnimation<Color>(
                                average >= 75 ? const Color(0xFF4DB6AC) : const Color(0xFFFFD54F),
                              ),
                              minHeight: 6,
                            ),
                          ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, i) {
        ...
        final pass = r.isPass;
        final statusColor = pass ? const Color(0xFF26A69A) : const Color(0xFFEF5350);
